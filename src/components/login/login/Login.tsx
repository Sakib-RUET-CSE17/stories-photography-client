...
const Login = () => {
    ...
    const handleError = (isFieldValid: boolean, errorMessage: string) => {
                ...
                <div className='col-md-6'>
                    ...
                    <div className="card">
                        <div className="card-body text-center">
                            ...
                            <button className='btn border-primary' onClick={googleSignIn}> <FcGoogle /> Continue with Google</button>
                        </div>
                    </div>
                </div>
                <div className='col-md-3'></div>
